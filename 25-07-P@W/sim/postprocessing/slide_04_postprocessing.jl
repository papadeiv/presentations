...
#=@showprogress=#for n in 1:Ns
        ...
        if tipped
                ...
                writeout([n, (n + tip_idx - 1), t_t[tip_idx], μ_t[tip_idx]], "../data/slide_04/tipping_point.csv")
                break
        end
...
writeout(coefficients, "../data/slide_04/coefficients.csv")

# Export the EWSs
writeout(hcat(t_var, u_var, u_esc, true_esc), "../data/slide_04/ews.csv")

# Export the horizontal and vertical shifts
writeout(hcat(x_s, y_s), "../data/slide_04/shifts.csv")

# Export the reconstruction error
writeout(error, "../data/slide_04/error.csv")
