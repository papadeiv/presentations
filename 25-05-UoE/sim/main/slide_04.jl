...
t, μ, u = evolve_ramped_1d(f, g, η, u0, δt=1e-3, saveat=0.10, μf=4.5)
...
# Export the data 
writeout(hcat(t,μ,u), "../data/slide_04/R-tipping.csv")
...
# Solve the fast-slow SDE
t, u = evolve_forward_1d(f, g, μ0, IC=x0, δt=1e-3, Nt=convert(Int64,1e4), saveat=0.05)

# Export the data 
writeout(hcat(t,u), "../data/slide_04/N-tipping.csv")

# Execute the postprocessing and plotting scripts
#include("../plotting/slide_04_postprocessing.jl")
